<script lang="ts">
    ...
    const variants: Record<ButtonVariant, string> = {
        primary:
            'bg-primary text-primary-foreground hover:bg-primary-hover shadow-md shadow-blue-500/5 border border-slate-700/50 hover:border-blue-500/50 active:shadow-blue-500/10',
        secondary:
        ...
        indigo: 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-md shadow-indigo-500/10 border border-indigo-500/40',
        'soft-blue':
    ...
    let computedClass = $derived(twMerge(baseStyles, variants[variant], sizes[size], className));
