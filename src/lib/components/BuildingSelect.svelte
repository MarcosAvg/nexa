<script lang="ts">
    ...
    /**
     * BuildingSelect — Select de edificios conectado al store global.
     *
     * @example
     * <BuildingSelect bind:value={buildingId} />
     */
    type Props = {
...
<CatalogSelect catalog={buildings} bind:value {placeholder} {disabled} class={className} {id} {onchange} />
