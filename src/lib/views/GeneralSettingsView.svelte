...
<div class="max-w-2xl">
    ...
    <Card class="p-5 lg:p-8 bg-white border border-slate-200 rounded-2xl shadow-sm space-y-8">
        <div class="flex items-start gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <div>
                ...
                <p class="text-xs font-medium text-slate-500 leading-relaxed">
                    Estos valores se usan en las plantillas de solicitudes y en los documentos/exportaciones
                    (nombre del sistema, datos de contacto del área y monto de reposición).
                </p>
            </div>
        </div>
        ...
        <div class="space-y-5">
            <div>
                ...
                <p class="text-[11px] text-slate-400 mt-1">
                    Se muestra en títulos y nombres de archivo de las exportaciones.
                </p>
            </div>

            <div>
                <label for="org-email" class="block text-sm font-medium text-slate-700 mb-1"
                    >Correo de contacto / envío</label
                >
                <div class="flex items-center gap-2">
                    ...
                    <Input
                        id="org-email"
                        type="email"
                        placeholder="ej. acceso@dominio.gob.mx"
                        bind:value={orgSupportEmail}
                    />
                </div>
                <p class="text-[11px] text-slate-400 mt-1">
                    Aparece en la hoja de instrucciones de la plantilla.
                </p>
            </div>

            <div>
                <label for="org-ext" class="block text-sm font-medium text-slate-700 mb-1"
                    >Extensión del área</label
                >
                <div class="flex items-center gap-2">
            ...
            <div>
                <label for="replacement-cost" class="block text-sm font-medium text-slate-700 mb-1"
                    >Monto de reposición</label
                >
                <div class="flex items-center gap-2">
                    <Coins size={16} class="text-slate-400 shrink-0" />
                    <Input
                        id="replacement-cost"
                        placeholder="Ej. $300.00 (Trescientos pesos 00/100 M.N.)"
                        bind:value={replacementCost}
                    />
                </div>
                <p class="text-[11px] text-slate-400 mt-1">
                    Se inserta en los textos legales mediante el token {'{monto}'}.
                </p>
            </div>
        </div>

        <div
            class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 border-t border-slate-100 pt-6"
        >
            <Button
                variant="indigo"
