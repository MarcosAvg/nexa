...
<div class="space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">
                    Ingresa los identificadores de los pisos separados por
                    comas.
                </p>
            </div>
        </div>
    ...
    >
        ...
        {#snippet footer()}
            <Button
                variant="secondary"
                onclick={() => (isAccessModalOpen = false)}>Cancelar</Button
            >
    ...
    >
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-[10px] text-slate-500 mt-2">
                    ...
                    <b>Operador:</b> Puede gestionar personal y tarjetas, pero
                    no completar tickets ni cambiar configuraciones.<br />
        ...
        {#snippet footer()}
            <Button
                variant="secondary"
                onclick={() => (isUserModalOpen = false)}>Cancelar</Button
            >
