-- Alta de persona: registrar el desglose del flujo (persona + tarjetas + asignación)
-- en un mismo flow_id, para que la historia muestre todos los pasos de la "alta".
    ...
    begin
        ...
        for v_i in 0 .. v_n - 1 loop
            ...
            values (
                ...
                coalesce(v_type_name, 'Tarjeta') || coalesce(' (Folio: ' || v_identifier || ')', ''),
                'CREATE',
