-- Efectos derivados en access_media → (auto) tickets de Programación / Firma Responsiva.
-- La definición se extrajo del estado real de la base (fuente de verdad).
...
begin
    ...
    -- Programación completada: cerrar el ticket "Programación" pendiente de esa tarjeta.
